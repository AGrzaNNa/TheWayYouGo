				...
				<div className="container">
					<div className="items">
						...
						<p className="description">
							"Embark on Your Journey of Self-Discovery! Explore
							new horizons, gain insights, and grow every step of
							the way. Join our community today and unlock your
							full potential. Together, let's navigate this
							exciting path towards personal growth and success!"
						</p>
				...
				<div className="container">
					<div className="items">
						...
						<p className="description">
							...
							Journey with an Interactive Map Featuring
							Specialized Filters. Explore the world your way,
							whether You want thanks to our interactive map
							planner!
						</p>
					</div>
				</div>
			...
			<div className="section">
				<div className="container">
					<div className="items">
						...
						<p className="description">
							"Post Your toughts give star to places u been share
							your experience with others. Show what u got Dont
							let it slide without any feelings!"
						</p>
